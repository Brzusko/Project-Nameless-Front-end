<template>
  <div id="edit" :class="{abs: !isRendex}">
    <div class="editor">
      <div class="loader" v-if="!isRendex">
        <img src="./arrows.svg" width="98px;" style="margin-bottom:20px;" :style="setAnime">
        <h3 class="text-center">Content is Loading</h3>
...
export default {
  ...
  data(){
    return{
      blogDatas: [
        {_id: '2313sadsad213', title: 'Dupa jasia', createdBy: 'Dupa', content: 'dupadupadupadupa', imgPath: 'https://i.imgur.com/QDeoStP.png'},
        {_id: '2313sadsad2131', title: 'Dupa Ani', createdBy: 'Jasio', content: 'asdasdsadsada', imgPath: 'https://i.imgur.com/QDeoStP.png'},
        {_id: '', title: '', createdBy: '', content: '', imgPath: 'https://i.imgur.com/QDeoStP.png'},
        {_id: '', title: '', createdBy: '', content: '', imgPath: 'https://i.imgur.com/QDeoStP.png'}
      ],
      blogData: {_id: '1', title: '1', createdBy: '1', imgPath: '1', content: '1'},
  ...
  mounted(){
    ...
    this.isEditor = this.getEditorState;
    if(this.isEditor == true)
    {
      ...
      this.fetchData(this.params.id).then((blog)=>{
        this.isRendex = blog;
  ...
  computed:{
    ...
    setAnime: function(){
      return{
        transform: `rotate(${this.loading}deg)`
      }
    }
  }
}
